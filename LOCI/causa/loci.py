...
def loci(x, y, independence_test=True, neural_network=True, return_function=False, n_steps=None, seed=711, device='cpu'):
    ...
    if neural_network:
        log_lik_forward, f_forward = het_fit_nn(x, y, n_steps=n_steps, seed=seed, device=device)
        log_lik_reverse, f_reverse = het_fit_nn(y, x, n_steps=n_steps, seed=seed, device=device)
