...
def roche(x, y, independence_test=False, return_function=False, n_steps=None, seed=711, device='cpu', verbose=False):
    ...
    log_lik_forward, f_forward = het_fit_nn(x, y, n_steps, seed=seed, device=device, verbose=verbose)
    log_lik_reverse, f_reverse = het_fit_nn(y, x, n_steps, seed=seed, device=device, verbose=verbose)
